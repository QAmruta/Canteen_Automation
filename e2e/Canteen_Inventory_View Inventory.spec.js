...
// delete the inventory entry
 //add name in search parameter for delete inventory entry
//   page.once('dialog', dialog => {
//     console.log(`Dialog message: ${dialog.message()}`);
//     dialog.dismiss().catch(() => {});
//   });
//   await page.getByRole('row', { name: '1 SHANKAR SABJI & FAL BHANDAR' }).locator('button').click();
...
// ============================
  ...
  if (rowExists) {
    ...
    console.log('⚠️ Row not found — may already be deleted or name is different');
  }
  ...
  //export button visible and click
